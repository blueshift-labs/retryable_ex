defmodule Retryable do
  ...
  @type options_or_name() :: options | atom
  ...
  * i.e. any tuple where the first element is `:error`
  ...
  @spec retryable(options_or_name :: options_or_name, func :: (-> term)) :: term
  def retryable(options_or_named_config \\ [], func)
  ...
  defp handle_error(value, %{error: false}, _, _count), do: value
